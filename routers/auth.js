...
router.post('/volunteer/changePassword', volunteer_permission, volunteer.changePassword);
...
router.post('/company/changePassword', company_permission, company.changePassword);
